      ...
      <div class="col xl10 offset-xl1 l8 offset-l2 m8 offset-m2 s12">
        ...
        <ol>
          ...
          <li><strong>${phrase(23)}</strong>
            <ol>
              <li>
                <p><strong><em>${phrase(24)}</em></strong></p>
                ${phrase(25)}
              </li>
              <li>
                <p><strong><em>${phrase(26)}</em></strong></p>
                ${phrase(27)}
              </li>
              <li>
                <p><strong><em>${phrase(28)}</em></strong></p>
                ${phrase(29)}
              </li>
              <li>
                <p><strong><em>${phrase(30)}</em></strong></p>
                ${phrase(31)}
              </li>
              <li>
                <p><strong><em>${phrase(32)}</em></strong></p>
                ${phrase(33)}
              </li>
              <li>
                <p><strong><em>${phrase(34)}</em></strong></p>
                ${phrase(35)}
              </li>
              <li>
                <p><strong><em>${phrase(36)}</em></strong></p>
                ${phrase(37)}
              </li>
              <li>
                <p><strong><em>${phrase(38)}</em></strong></p>
                ${phrase(39)}
              </li>
              <li>
                <p><strong><em>${phrase(40)}</em></strong></p>
                ${phrase(41)}
              </li>
            </ol>
          </li>
